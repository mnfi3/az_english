                        ...
                        <div class="col-12" >
                            <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="300ms" style="border-radius: 10px">
                                ...
                                <div class="mb-50 ">
                                    ...
                                    <img src="{{$partnership->image->path}}" alt="" style="border-radius: 10px">
                                    @endif
                                </div>
                                <!-- Post Title -->
                                <p class="text-dark " style="font-weight: 500; font-size: 1.5rem">{{$partnership->title}}</p>
                                <!-- Post Meta -->
                                <div class="post-meta py-3">
                                    <p>{{date_format($partnership->created_at, 'g:ia \o\n l jS F Y')}}</p>
                                </div>
                                <!-- Post Excerpt -->
                                <p class="" style="font-size: 1.1rem">
                                    @php
                                    echo $partnership->content;
                                    @endphp
                                </p>
                                <!-- Download Docs btn -->
                                @php($i=0)
                                @foreach($partnership->docs as $doc)
